 ...
 */
package com.mining.modle.waterdroplistview.view;
...
import com.mining.modle.waterdroplistview.utils.Utils;
    ...
    public void setVisiableHeight(int height) {
        ...
        if(mState == STATE.stretch){
           ...
           /* if(pullOffset < 0 || pullOffset >1){
            ...
            if(pullOffset<0){ pullOffset=0; }else if(pullOffset>1){ pullOffset=1; }
