...
/*充值记录*/
public class RechargeRecordActivity extends BaseActivity implements WaterDropListView.IWaterDropListViewListener  {
    ...
    public void initView() {
        title_text.setText(getResources().getString(R.string.s4));
    ...
    private MessageBean[] initData() {
        ...
        msgArray[0] = new MessageBean("0.00725445","已完成","16:48 03/11");
        msgArray[1] = new MessageBean("0.00725445","已完成","16:48 03/11");
        msgArray[2] = new MessageBean("0.00725445","已完成","16:48 03/11");
        msgArray[3] = new MessageBean("0.00725445","已完成","16:48 03/11");
        return msgArray;
    }
    /**
     * 点击 PopupWindow
