...
import com.mining.modle.adapter.WithdrawalsRecordAdapter;
...
/*提币记录*/
public class WithdrawalsRecordActivity  extends BaseActivity implements WaterDropListView.IWaterDropListViewListener   {
    ...
    //自定义Adapter
    private WithdrawalsRecordAdapter listAdapter;
    ...
    public void initView() {
        ...
        listAdapter = new WithdrawalsRecordAdapter(this, R.layout.item_withdrawals_record, initData());
    ...
    private MessageBean[] initData() {
        ...
        msgArray[0] = new MessageBean("0.00725445","等待打包","16:48 03/11","1LSLwpoD2XRwEfzEkEvf4Bwkr2q3o6vfau");
        msgArray[1] = new MessageBean("0.00725445","等待打包","16:48 03/11","1LSLwpoD2XRwEfzEkEvf4Bwkr2q3o6vfau");
        msgArray[2] = new MessageBean("0.00725445","等待打包","16:48 03/11","1LSLwpoD2XRwEfzEkEvf4Bwkr2q3o6vfau");
        msgArray[3] = new MessageBean("0.00725445","等待打包","16:48 03/11","1LSLwpoD2XRwEfzEkEvf4Bwkr2q3o6vfau");
        return msgArray;
    }
    /**
     * 点击 PopupWindow
