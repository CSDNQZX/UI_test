...
/*划转记录*/
public class TransferRecordActivity extends BaseActivity implements WaterDropListView.IWaterDropListViewListener  {
    ...
    public void initView() {
        title_text.setText(getResources().getString(R.string.y2));
        listAdapter = new ListAdapter(this, R.layout.item_transfer_record, initData());
    ...
    private MessageBean[] initData() {
        ...
        msgArray[0] = new MessageBean("1563.32","成功","16:48 03/11");
        msgArray[1] = new MessageBean("1563.32","成功","16:48 03/11");
        msgArray[2] = new MessageBean("1563.32","成功","16:48 03/11");
        msgArray[3] = new MessageBean("1563.32","成功","16:48 03/11");
        msgArray[4] = new MessageBean("1563.32","成功","16:48 03/11");
        msgArray[5] = new MessageBean("1563.32","成功","16:48 03/11");
        return msgArray;
    }
    /**
     * 点击 PopupWindow
